 ...
 * </p>
 * <ul>
 *   <li>{@link trs.impl.AlgorithmImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class AlgorithmImpl extends MinimalEObjectImpl.Container implements Algorithm {
	...
	protected EClass eStaticClass() {
		return TrsPackage.Literals.ALGORITHM;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TrsPackage.ALGORITHM__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TrsPackage.ALGORITHM__NAME:
				return getName();
		}
